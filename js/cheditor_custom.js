...
function setConfig() {
    this.config = {
        ...
        tabIndex: 0,
        //editorPath      : 'http://imgs.career.co.kr/CHEditor1/',
        editorPath: '.',
        ...
        allowedMaxImgSize: 0,
        imgUploadFolder: '.',
        uploadDomainPath: 'http://imgs.career.co.kr/CHEditor/'
    };
...
cheditor.prototype = {
    ...
    getImgFolder: function () {
        return this.config.imgUploadFolder;
    },
    ...
    setFolderPath: function () {
        ...
        //	this.config.editorPath = 'http://imgs.career.co.kr/CHEditor1/';
        this.config.iconPath = 'http://members.career.co.kr/CHEditor1/icons/';
        this.config.cssPath = 'http://members.career.co.kr/CHEditor1/css/';
        this.config.popupPath = 'http://members.career.co.kr/CHEditor1/popup/';
    },
    ...
    openDoc: function (doc, contents) {
        doc.open();
        var html = '<html><head><title>' + this.config.docTitle + '</title><style></style></head><body id="view_wrap">';
    ...
    setDefaultCss: function (ar) {
        ...
        if (arguments.length == 0) {
            var css2 = head.appendChild(ar.doc.createElement('link'));
            css2.setAttribute('type', 'text/css');
            css2.setAttribute('rel', 'stylesheet');
            css2.setAttribute('media', 'all');
            css2.setAttribute('href', 'http://www.career.co.kr/css/jobs_2011.css?131111');
            /*
            var css3 = head.appendChild(ar.doc.createElement('link'));
            css3.setAttribute('type', 'text/css');
            css3.setAttribute('rel', 'stylesheet');
            css3.setAttribute('media', 'all');
            css3.setAttribute('href', 'http://wtest.career.co.kr/css/topGnb_2012v1.css?131111');

            var css4 = head.appendChild(ar.doc.createElement('link'));
            css4.setAttribute('type', 'text/css');
            css4.setAttribute('rel', 'stylesheet');
            css4.setAttribute('media', 'all');
            css4.setAttribute('href', 'http://wtest.career.co.kr/css/gnb_2013.css?131111');
            */
        }
    },
    ...
    putContents: function (content) {
        ...
        var obj = this.doc.body.getElementsByTagName('OBJECT');
    ...
    doEditorEvent: function () {
        ...
        if (self.config.showTagPath) {
            ...
            remove.onclick = function () {
                oEditor.document.execCommand("Cut", false, null);
                remove.style.display = 'none';
                oEditor.focus();
                self.doEditorEvent();
            };
